...
export const mealLogInputSchema = z.object({
  ...
  ingredients: z
    ...
    .optional(),
  // True when the recipe being saved was GENERATED by AI from just a dish
  // name. Persisted to `meals.recipe_is_ai_draft` so the recipe view can flag
  // it "review this". Cleared when the user edits or refines the recipe.
  recipeGenerated: z.boolean().optional()
});
