...
import { getRecipeShareByToken } from "@/services/shares";
...
export async function generateMetadata(props: {
  ...
  if (!share) {
    return {
      title: "Recipe no longer shared — eeatly",
    ...
    return (
      <section className="mx-auto grid max-w-2xl gap-4 px-4 py-12 sm:px-6">
        ...
        <p className="text-sm text-muted-foreground">
          The link may have been revoked, or the recipe was deleted. Ask whoever
