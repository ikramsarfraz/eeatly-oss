...
const topics: Topic[] = [
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        generate a public link you can send over WhatsApp, iMessage, or anywhere
        else. The recipient doesn&apos;t need an eeatly account to view it. You
        can revoke the link any time from the same screen.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Go to <span className="font-medium text-foreground">Settings</span> and
  ...
  },
  {
    ...
    answer: (
      <>
        Short version: only what you log is saved, audio is never persisted on
        our servers, and there are no ad cookies or third-party analytics. The
        long version lives on the{" "}
        <Link
          href={"/privacy" as Route}
          className="underline underline-offset-4 hover:text-foreground"
        >
...
export default function HelpPage() {
  return (
    <div className="mkt-doc mx-auto max-w-2xl px-4 py-12 sm:px-6 lg:px-8">
      <h1
        className="font-serif text-[40px] font-normal"
        style={{ letterSpacing: "-0.02em" }}
      >
        Help
      </h1>
      <p className="mt-3 text-muted-foreground">
        Short answers to the questions that come up most. If yours isn&apos;t
        here,{" "}
        <Link
          href="/sign-up"
          className="underline underline-offset-4 hover:text-foreground"
