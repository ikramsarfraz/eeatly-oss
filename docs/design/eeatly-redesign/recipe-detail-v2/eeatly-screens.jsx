...
function ScreenRecipeDetail({ dark = false } = {}) {
  ...
  const ingredients = [
    { name: 'Chicken', qty: '400 g', note: 'boneless, sliced' },
    { name: 'Salt', qty: '1 tsp' },
    { name: 'Red pepper', qty: '½ tsp' },
    { name: 'Black pepper', qty: '½ tsp' },
    { name: 'Garlic powder', qty: '1 tsp' },
    { name: 'Onion powder', qty: '1 tsp' },
    { name: 'Paprika powder', qty: '1 tsp' },
    { name: 'Cumin powder', qty: '½ tsp' },
    { name: 'Ketchup', qty: '3 tbsp' },
    { name: 'Sriracha', qty: '1 tbsp' },
    { name: 'Chilli garlic sauce', qty: '1 tbsp' },
    { name: 'Soy sauce', qty: '2 tbsp' },
    { name: 'Vinegar', qty: '1 tbsp' },
    { name: 'Carrot', qty: '1 large', note: 'julienned' },
    { name: 'Bell pepper', qty: '1', note: 'sliced thin' },
    { name: 'Cabbage', qty: '2 cups', note: 'shredded' },
    { name: 'Onions', qty: '1 medium', note: 'sliced' },
    { name: 'Noodles', qty: '250 g', note: 'boiled, drained' },
  ];
  ...
  const steps = [
    {
      ...
      time: '10 min · then 20 min rest',
      body: 'Combine the chicken with salt, both peppers, garlic, onion, paprika and cumin. Toss until evenly coated and rest for 20 minutes while you prep the rest.',
    ...
    },
    {
      ...
      title: 'Mix the sauce',
      time: '2 min',
      body: 'Whisk ketchup, sriracha, chilli garlic sauce, soy sauce and vinegar in a small bowl until smooth. Set aside within arm\u2019s reach of the stove.',
    ...
    },
    {
      ...
      time: '8 min',
      body: 'Julienne the carrot, slice the bell pepper and onion thin, and shred the cabbage. Keep them on one plate \u2014 they all go in together.',
    ...
    },
    {
      ...
      time: '6 min',
      body: 'Heat a wok over high heat. Add the marinated chicken in one layer, sear undisturbed for 2 minutes, then toss until just cooked through. Move to a plate.',
      items: ['Chicken'],
    },
    {
      n: 5,
      title: 'Stir-fry & toss',
      time: '5 min',
      body: 'In the same wok, fire the vegetables for 2 minutes on high \u2014 they should stay crisp. Return the chicken, add the boiled noodles and pour in the sauce. Toss for a minute until everything is glossy.',
      items: ['Carrot', 'Bell pepper', 'Cabbage', 'Onions', 'Noodles', 'Chicken'],
    },
  ];
    ...
    <Phone dark={dark}>
      ...
      <Content pad={22}>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 26 }}>
          ...
          <Chip tone="ghost">~30 min · serves 4</Chip>
          <Chip tone="wheat">{steps.length} steps</Chip>
        </div>
          ...
          {ingredients.map((ing, i) => {
            ...
            return (
              <div key={ing.name} style={{
                ...
                <div style={{
                  flex: 1, minWidth: 0, fontSize: 14.5, color: on ? E.ink3 : E.ink,
                  ...
                  {ing.note && (
                    <span style={{
                      fontSize: 11.5, fontWeight: 400, color: E.ink3,
                ...
                <div style={{
                  fontFamily: F.mono, fontSize: 11.5, color: on ? E.ink4 : E.ink2,
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14, marginBottom: 18 }}>
          {steps.map((step, idx) => (
            <Card key={step.n} padding={18}>
              ...
              <div style={{
                fontSize: 14, lineHeight: 1.5, color: E.ink2,
                letterSpacing: -0.1, marginBottom: 12, marginLeft: 40,
                textWrap: 'pretty',
              }}>{step.body}</div>
              ...
              {idx < steps.length - 1 && (
                <div style={{
                  marginLeft: 12, marginTop: 14, marginBottom: -4,
                  ...
                  <span style={{
                    ...
                    textTransform: 'uppercase', color: E.ink4,
                  }}>then</span>
                </div>
              )}
            </Card>
